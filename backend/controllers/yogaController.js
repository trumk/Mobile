    ...
    exports.checkClassTypesAvailability = async (req, res) => {
        ...
        try {
            ...
            if (existingCourse) {
                return res.status(400).json({ message: 'One or more selected class types are already assigned to another course' });
            }
    ...
    exports.createCourse = async (req, res) => {
        ...
        try {
            ...
            const existingCourse = await YogaCourse.findOne({ classType: { $in: classTypeIds } });
            if (existingCourse) {
                return res.status(400).json({ message: 'One or more selected class types are already assigned to another course' });
            }
