...
const HikeEdit: React.FC<HikeEditProps> = ({ hike, onSubmit }) => {
  ...
  useEffect(() => {
    if (location && locationEnd) {
      ...
      setLength(parseFloat(calculatedLength.toFixed(2)));
    }
    ...
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.container}>
        ...
        <MapView
          style={styles.map}
          initialRegion={{
            latitude: parseFloat(location.split(",")[0]) || 16.047079,
            longitude: parseFloat(location.split(",")[1]) || 108.20623,
            latitudeDelta: 8.0,
            longitudeDelta: 8.0,
          }}
          onPress={(e) =>
        ...
        <MapView
          style={styles.map}
          initialRegion={{
            latitude: parseFloat(locationEnd.split(",")[0]) || 16.047079,
            longitude: parseFloat(locationEnd.split(",")[1]) || 108.20623,
            latitudeDelta: 8.0,
            longitudeDelta: 8.0,
          }}
          onPress={(e) =>
        ...
        <TextInput
          ...
          onChangeText={(value) => {
            ...
            setLength(isNaN(numericValue) ? 0 : numericValue);
          }}
        />
